  ...
  IconPicker.prototype.render = function (options) {
    ...
    var a = {
      ...
      createList: function (text) {
        ...
        for (var i = 0; i < l; i++) {
          ...
          // 每个图标dom
          var icon =
            '<div class="layui-iconpicker-icon-item" title="' +
            obj +
            '" ' +
            style +
            ">";
      ...
      page: function () {
        var icon =
          "#" + PAGE_ID + " .layui-iconpicker-page-operate .layui-icon";
    ...
    var common = {
      ...
      loadCss: function () {
        ...
        if ($style.length === 0) {
          $("head").append(
            '<style rel="stylesheet" iconpicker>' + css + "</style>"
          );
        }
      },
